...
public class Monitor extends BroadcastReceiver {
     ...
     * @param intent
     *
     * Get bettery information from the system intent.
    ...
    public void monitorBatery(Context context, Intent intent){
        if(intent!=null) {
            ...
            long levelNanoWatt = intent.getLongExtra(String.valueOf(BatteryManager.BATTERY_PROPERTY_ENERGY_COUNTER), -1);
            if (levelNanoWatt != -1) {
                Dataset.getInstance().setBatteryNanoWatt(levelNanoWatt);
            }
        }
    }
     ...
     * @param context
     *
     * Monitor connectivity from android syatem service
     */
